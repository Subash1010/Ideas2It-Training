...
public class KafkaConfig {
	...
	@Bean
	public ConsumerFactory<String, AuditDto> consumerObjectFactory() {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, AuditDto> kafkaContainerObjectConsumerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, AuditDto> consumerFactory = new ConcurrentKafkaListenerContainerFactory<>();
