...
class UpdateVSComponent extends Component {
    constructor(props) {
        super(props)
    ...
    onSave = (event) => {
        ...
        if ((users.patientId !== undefined && users.patientId !== null && users.patientId !== "") &&
            ...
            VSService.updateUser(users.patientId, users.checkupDate, users).then(res => {
                ...
                <Container maxWidth="sm">
                    <div>
                        ...
                        <Typography variant="h3" gutterBottom>
                            Update Patient Vital Sign Detail
                        </Typography>
...
export default UpdateVSComponent;
